...
//////////////////
  ...
  private int getRangeIndex(InetAddress ip){
     int index = 0;
     Enumeration enum1 = hosts.elements();
     while(enum1.hasMoreElements()){
       InetRange ir = (InetRange) enum1.nextElement();
  ...
  private String userNames(int i){
    ...
    Enumeration enum1 = ((Hashtable)users.elementAt(i)).keys();
    if(!enum1.hasMoreElements()) return "";
